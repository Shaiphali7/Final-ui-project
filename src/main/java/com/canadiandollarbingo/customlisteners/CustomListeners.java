package com.canadiandollarbingo.customlisteners;
...
import static com.canadiandollarbingo.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("Canadian Dollar Bingo");
